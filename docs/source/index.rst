...
When the battery power is low, you can insert a 5V/2A Micro USB cable to charge the batteries, and the charging indicator will light up and turn off when fully charged.
